...
async def create_expense(
    ...
    if receipt and receipt.filename:
        ...
        receipt_path = f"/static/receipts/{unique_filename}"
    ...
    try:
        ...
        if receipt_path:
            full_path = os.path.join(os.path.dirname(__file__), receipt_path.lstrip("/"))
...
async def update_expense(
    ...
    try:
        ...
        if receipt and receipt.filename:
            if receipt_path:
                old_file = os.path.join(os.path.dirname(__file__), receipt_path.lstrip("/"))
...
def delete_expense(expense_id: int):
    ...
    try:
        ...
        if existing["receipt_path"]:
            file_path = os.path.join(os.path.dirname(__file__), existing["receipt_path"].lstrip("/"))
